chords[] = {0.05, 0.1, 0.15, 0.1, 0.05}; chords[] += chords[];
alphas[] = {0*Pi/180,10*Pi/180,20*Pi/180,30*Pi/180,40*Pi/180}; alphas[]+=alphas[];
radius_multipliers[] = {4,4,4,4,4}; radius_multipliers[] += radius_multipliers[];
le_rotates[] = {1*Pi/180,1*Pi/180,1*Pi/180,1*Pi/180,1*Pi/180};le_rotates[] += le_rotates[];
le_radius[] = {.25*.0254,.25*.0254,.25*.0254,.25*.0254,.25*.0254};le_radius[]+=le_radius[];
le_span_multipliers[] = {0.005,0.005,0.005,0.005,0.005};le_span_multipliers[]+=le_span_multipliers[];
dtex[] = {0.0, 0.0, 0.0, 0.0};dtex[]+={dtex[],dtex[0]};
dtex[4] = -0.25;
dtey[] = {-0.02, -0.02, -0.02, -0.02};dtey[] +={dtey[],dtey[0]};
dtey[4] = -0.2;
leadjust = 35*Pi/180;
...
pts[] = {};
Point(ce++) = {0,-.20,0,plate_lc};pts[]+=ce;
Point(ce++) = {.5,-.4,0,plate_lc};pts[]+=ce;

Line(ce++) = pts[];
Line{ce} In Surface{plate_surf};
